...
const About = () => {
  ...
  return (
   <>
     <Metas
      title={ `${ settings?.site.name } | Nosotros` }
      description='En +57 Productos, nacimos con el propósito de transformar vidas y destacar la riqueza agrícola de
               Colombia.'
      type='website'
     />
     <section className='page-about-us m-0 p-0 relative'>
       <InfoAbout/>
       <MissionAndVision/>
       <section id='ourHistory' className='py-14'>
         <div className='container mx-auto px-3'>
           ...
           <div className='content-section text-15 tl:text-lg text-Primary w-full'>
             <p>
               En +57 Productos, nacimos con el propósito de transformar vidas y destacar la riqueza agrícola de
               Colombia.
               Todo comenzó al identificar la necesidad de nuestros campesinos de obtener un precio justo por su
               esfuerzo
             ...
             <br/>
             <p>
               Hoy, somos más que una empresa exportadora. Somos un puente que conecta a los agricultores colombianos
               con
