    ...
    <>
      <div>
        <div className=' flex justify-center items-end w-auto'>
          <div class='grafic inline-flex gap-3 justify-center items-end bg-gray-200 border-x-2 border-x-gray-50 border-y-2 border-y-blue-800 py-12 px-8 rounded-full hover:border-y-gray-50 hover:border-x-blue-800 hover:cursor-pointer'>
