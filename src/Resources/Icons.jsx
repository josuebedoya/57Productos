...
import { FaArrowRight, FaRegHeart, FaStar, FaRegEye, FaPencilAlt, FaSeedling, FaTrash, FaTrashRestore, FaFacebook, FaYoutube, FaTiktok, FaWhatsapp } from 'react-icons/fa';
...
export const InstagramColorIcon  = ({ atr, classIcons }) => {
  return (
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px" style={atr} className={classIcons}>
     <path fill="#304ffe"
