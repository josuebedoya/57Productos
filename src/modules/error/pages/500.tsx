  ...
  return (
    <>
      ...
      <section className='sm:container max-w-[500px] mx-auto py-10'>
        <div className='text-Primary text-lg text-center font-bold'>!Ups, algo ha salido mal¡
        </div>
        <div className='text-red-600 text-3xl text-center font-bold family-oswald mt-4'>500</div>
