import safelist from './src/utils/tailwind.class';
...
module.exports = {
  important: true,
  darkMode: 'class',
  safelist: [ ...safelist, 'flex', 'flex-col', 'min-h-screen', '!hidden' ],
  content: [
  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'fade-down-in': 'fade-down-in .33s ease-in both',
        'fade-down-out': 'fade-down-out .33s ease-in both',
        'fade-left-out': 'fade-left-out .33s ease-in both',
        'fade-left-in': 'fade-left-in .33s ease-in both',
        'fade-right-out': 'fade-right-out .33s ease-in both',
        'fade-right-in': 'fade-right-in .33s ease-in both',
      },
      keyframes: {
        'fade-out': {
          '0%': { opacity: 1 },
