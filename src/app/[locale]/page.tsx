        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6">
            <h1 className="text-5xl md:text-6xl font-semibold tracking-tight leading-tight">
              Conectamos el campo colombiano con el mercado internacional
            </h1>

            <p className="text-lg text-gray-600 max-w-xl">
              Trabajamos directamente con agricultores para llevar productos reales a compradores internacionales de
              forma clara y segura.
            </p>

            {/* Tags */}
            <div className="flex gap-3 flex-wrap text-sm">
              <span className="px-3 py-1 rounded-full bg-gray-100">Producción real</span>
              <span className="px-3 py-1 rounded-full bg-gray-100">Exportación</span>
              <span className="px-3 py-1 rounded-full bg-gray-100">Conexión directa</span>
            </div>
          ...
          <div className="relative w-full h-[400px] rounded-2xl overflow-hidden shadow-md">
            <Image
              src="/hero-productos.jpg" // reemplaza por tu imagen real
