  ...
  return (
   <div className={`${classContent ? classContent : ''} input w-full flex-col items-center justify-center`}>
     ...
     <Component
      ...
      id={name}
      required={isRequired}
      className={`bg-transparent text-Primary text-sm rounded-xl border border-Primary py-2 px-5 focus:outline-none focus:shadow-custom w-full ${classInput && classInput}`}
     />
   </div>
  );
};
