...
export function Carousel({ items = [], itemsView = 3, itemsSpace = 10, navs = false, dots = false, effect = 0, lineProgress = false, itemClass = '', autoplay = false, autoplayDelay = 2500, loop = false, cursor = false, centerItems = false, responsive = [] }) {
